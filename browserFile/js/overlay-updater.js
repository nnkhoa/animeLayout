...
function newDynText(name, x, y, maxWidth, fontsize, fontcolor, align) {
  let dynamicText = new createjs.Text(
    "",
    `${fontsize}px UTM Akashi`,
    fontcolor
  );
  dynamicText.x = x;
  dynamicText.y = y;
  dynamicText.maxWidth = maxWidth;
  dynamicText.textAlign = align;
...
function pollHandler() {
  xhr.open('GET', 'tournamentData/streamcontrol.xml');
  xhr.send();
