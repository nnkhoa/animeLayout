...
function pollHandler() {
	xhr.open('GET', "tournamentData/streamcontrol.json?"+cacheBusterValiable+"="+cacheBuster,true);
	xhr.send();
	cacheBuster++;
}
...
function update() {
	...
	if (firstupdate) {
        ...
        document.getElementById('round').innerHTML = scObj['round'];
        ...
        TweenMax.from(document.getElementById('round'),0.5,{opacity:0,delay:1.5,onComplete:function(){animating--;}});

        document.getElementById("container").style.display="block";
        textFit(document.getElementsByClassName('round'), {minFontSize:10, maxFontSize: 14,multiLine: false});
        ...
        if (document.getElementById('round').innerHTML != scObj['round']) {
            animating++;
            TweenMax.to(document.getElementById('round'),0.5,{opacity:0,ease:Quad.easeIn,onComplete: function() {
                document.getElementById('round').innerHTML = scObj['round'];
                textFit(document.getElementsByClassName('round'), {minFontSize:10, maxFontSize: 14,multiLine: false});
            }});
            TweenMax.to(document.getElementById('round'),0.5,{opacity:1,delay:0.5,ease:Quad.easeOut,onComplete: function(){
                animating--;
            }});
        }
	}
...
function loadFlags() {
	...
	document.getElementById("flag1").src = "images/GoSquared/expanded/" + currCountry1 + ".png";
	document.getElementById("flag2").src = "images/GoSquared/expanded/" + currCountry2 + ".png";
